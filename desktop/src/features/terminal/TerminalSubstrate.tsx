...
export function TerminalSubstrate({
  ...
  return (
    ...
    >
      {mode === "docked" ? (
        <hr
          aria-label={`Resize ${PRODUCT_SHORT} Term`}
      ...
      <div className="buzz-terminal-contract-bar">
        <div className="buzz-terminal-tabs" role="tablist">
          ...
          <button
            aria-label={`New ${PRODUCT_SHORT} Term tab`}
        ...
        <div className="buzz-terminal-readout">
          <button
            aria-label={
              mode === "maximized"
                ? `Restore ${PRODUCT_SHORT} Term`
                : `Maximize ${PRODUCT_SHORT} Term`
            }
          ...
          <button
            aria-label={`Hide ${PRODUCT_SHORT} Term`}
            className="buzz-terminal-window-action"
            onClick={onHide}
            type="button"
          >
