...
// centered Cybota mark turning over it. SpinningMark is plain SVG + CSS, so
// it paints on the very first frame even before scripting starts, avoiding a
// blank flash on hard reload. Replaces the old "Setting up your community"
// text, which stays as an sr-only caption.
function AppLoadingGate() {
  return (
    ...
    >
      ...
      <SpinningMark className="relative z-10 w-28 text-foreground" />
    </div>
  );
}
